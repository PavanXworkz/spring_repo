 ...
 -->			<a class="navbar-brand" href="index.jsp">Home</a> <a class="navbar-brand align-item-right" href="#">Driving License</a>
	...
	<form action="dl" method="post">
		<div class="row g-3">
			...
			<div class="col-md-6 mb-2">
				<input id="middleName" type="text" class="form-control" placeholder="Middle name" name="middleName">
			</div>
			...
			<div class="col-md-6 mb-2">
				<input id="lastName" type="date" class="form-control" placeholder="" name="dateOfBirth" required>
			</div>



			<div class="col-md-6 mb-2">
				<input id="age" type="tel" class="form-control" placeholder="enter your age" name="age" required>
			...
			<div class="col-md-6 mb-2">
				<input id="education" type="text" class="form-control" placeholder="Education" name="Education">
			</div>
			<div class="col-md-6 mb-2">
				<input id="booldGroup" type="text" class="form-control" placeholder="BloodGroup" name="bloodGroup" required>
		...
		<div class="row g-3">
		<div class="col-md-6 mb-2">
				<input id="identy" type="text" class="form-control" placeholder="Identity Mark" name="mark" required>
			</div>
			</div>
			<div class="row g-3">
				<div class="col-md-6 mb-2">
			...
			<div class="col-md-6 mb-2">
				...
				<div class="col-md-6 mb-2">
				<input id="firstName" type="text" class="form-control" placeholder="Witness Name" name="witnessName" required>
			...
			<input type="button" value="cancle" class="btn btn-warning">
