...
public class Resort1Controller {
	...
	public String findByEmail(@RequestParam String emailId, Model model) {

		List<Resort1DTO> list=service.findEmail(emailId);
		System.out.println("email cont="+emailId);
		model.addAttribute("findemail", list);
